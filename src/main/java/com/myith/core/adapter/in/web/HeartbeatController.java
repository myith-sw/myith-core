...
public class HeartbeatController {
    ...
    @Operation(
            ...
            description = """
                    ...
                    서버는 마지막 실제 서비스 활동 시각(last_active_at) 기준으로 미접속 시간을 판정해 nudge: true로 응답합니다.
                    heartbeat 자체는 활동 시각을 갱신하지 않습니다. (갱신하면 판정이 동작하지 않습니다.)

                    넛지 우선순위 (복수 성립 시 하나만 반환):
                    1. ABSENCE_48H — 48시간 미접속
                    2. UPSET — 24시간 미접속
                    3. ANNOYING — 12시간 미접속 + OPEN 퀘스트 3개 이상
    ...
    record HeartbeatResponse(
            ...
            boolean nudge,
            @Schema(description = "넛지 종류. nudge=false이면 null", allowableValues = {"ANNOYING", "UPSET", "ABSENCE_48H"}, nullable = true)
            String nudgeType,
